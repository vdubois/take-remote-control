...
La prise de contrôle s'effectue par l'exécution de commandes à distance sur chacun des postes, au travers du protocole SSH.
...
On doit générer une clé privée et une clé publique pour échanger notre clé publique avec les autres postes et que l'on puisse y lancer des commandes
...
Pour installer la clé SSH sur les postes, lancer la commande suivante pour chacun des postes distants :
